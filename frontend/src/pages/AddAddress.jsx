...
const InputField = ({type, placeholder, name, handleChange, address})=>(
    <input className='w-full h-10 px-2.5 border border-gray-500/30 rounded outline-none text-gray-500 focus:border-primary transition'
    type={type}
  ...
  return (
    <div className='mt-16 pb-16'>
      ...
      <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
        ...
        <img className='md:mr-16 mb-16 md:mt-0 w-90 h-90' src={assets.add_adresse_image} alt='Add Address'  />
      </div>
    </div>
  )
}
