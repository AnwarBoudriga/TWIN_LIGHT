...
const Cart = () => {
    ...
    const {products, currency, cartItems, removeFromCart, getCartCount, getCartAmount,
    updateCartItem, navigate, axios, user, setCartItems} = useAppContext()
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button onClick={()=> {navigate("/products"); scrollTo(0,0)}} className="group cursor-pointer flex items-center mt-8 gap-2 text-primary font-medium">
                    <img className="group-hover:-translate-x-1 transition w-6 h-6" src={assets.arrow_right_icon_colored} alt="arrow" />
                    Continue Shopping
                </button>
